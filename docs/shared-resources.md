...
- **Admin → Community → Logistics → Shared Resources** (a collapsed section on `/admin`; moved out of Program 2026-07-03 — coordination is community logistics, not programming) (`ResourcesManager.tsx`):
