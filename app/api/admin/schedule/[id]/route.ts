...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const allowed = ['day','time','title','subtitle','detail_desc','icon_type','sort_order','visible','highlight','is_recurring','participation_type','shift_type_id','requires_ack','event_date','event_category','start_time','end_time','needs_lead','recurrence_days','show_on_schedule']
