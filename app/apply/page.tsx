      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '0 1.5rem 6rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <p style={{ fontSize: '1rem', lineHeight: 1.8, marginBottom: '1rem' }}>
            Glåüm is a participatory camp built collaboratively by The Many Hands.
            This form helps us understand who's joining camp, how people would like to contribute,
            and what support structures we need to build together.
          </p>
          <p style={{ fontSize: '1rem', lineHeight: 1.8, marginBottom: '1rem' }}>
            You do not need to be the most skilled, experienced, outgoing, or useful person in the
            world to join Glåüm.
          </p>
          <p style={{ fontSize: '1rem', lineHeight: 1.8, fontStyle: 'italic', opacity: 0.7 }}>
            You simply need to be willing to participate honestly, communicate clearly, and help hold
            the camp with us in whatever ways are realistic for you.
          </p>
        </div>
